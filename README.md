...
**이득은 예산 구간에 따라 부호가 갈립니다 — 켜기 전에 보십시오.** 아래는 en-ko 벤치마크
(TED2020 500건 · `qwen2.5:3b` + `bge-m3`)에서 Tier 0만 쓴 결과와 Tier 1을 켠 결과를
나란히 잰 것입니다.

| 예산 | 의미 반전(`negation`) Recall | **전체 Recall** | 전체 오류 순증 |
|---|---|---|---|
| 30% | 19.72% → **42.25%** | 88.0% → **91.2%** | **+16건** |
| 10% | 1.41% → **4.23%** | 73.2% → **72.8%** | **-2건** |

**예산 10%에서는 의미 반전 2건·숫자 누락 2건을 얻는 대신 규격 위반 6건을 잃습니다.**
Tier 1 후보가 회색지대 전역에서 컷라인까지 올라오면서 그만큼을 아래로 밀어내기 때문입니다
— 순위는 보존량이라 누군가 올라오면 누군가는 내려갑니다. 예산 30%에서는 회색지대가 좁아
그 대가가 작고 순증이 +16건입니다. **낮은 예산에서는 Tier 0만 쓰는 편이 전체 Recall에
유리합니다.** 다만 **의미 반전만 놓고 보면 어느 예산에서도 Tier 1이 높습니다** — 무엇을
찾으려 켜는지에 따라 답이 갈립니다. 근거:
[`bench/results/pushout-en-ko-2026-09-12.md`](bench/results/pushout-en-ko-2026-09-12.md).
