...
#### Tier 1 역번역 — `--embed-model` (FR-4.2, 신호는 동작하고 후보 선정이 미완입니다)
...
**미완인 것은 후보 선정입니다.** Tier 1 후보를 Tier 0 위험도 순위로 고르는데, 의미 반전은
Tier 0가 원리적으로 못 잡아 그 순위에서 무작위 위치에 놓입니다 — 신호가 볼 기회를 얻지
못합니다(실측: 예산 10% negation Recall 1.41% → 0.00%). 다음 작업이 이 후보 선정을
재설계합니다. 상세: [`bench/results/en-ko-2026-09-05.md`](bench/results/en-ko-2026-09-05.md).
