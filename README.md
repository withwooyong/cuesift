...
**실제 검수 비율 10%에서 무작위 대비 약 7배**(en-ko **6.96x** · ja-ko **7.06x**)의
...
> 가장 오해 없이 인용할 수 있는 값입니다 — 더 낮은 예산(1~5%)은 배수가 8.6배까지
...
| --- | --- | --- | --- | --- | --- | --- |
| 1% | 6.32% | 54.60% | 8.64x | 5.82% | 50.00% | 8.59x |
| 2% | 6.32% | 54.60% | 8.64x | 5.82% | 50.00% | 8.59x |
| 5% | 6.32% | 54.60% | 8.64x | 5.82% | 50.00% | 8.59x |
| **10%** | **10.00%** | **69.60%** | **6.96x** | **10.00%** | **70.60%** | **7.06x** |
...
6.32% · ja-ko 5.82%)보다 낮은 동안은 요청을 더 낮춰도 결과가 바뀌지 않습니다.
...
필요한 이유입니다(요구사항정의서 §12 Q4). 또한 **ko 자막의 약 절반(en-ko
