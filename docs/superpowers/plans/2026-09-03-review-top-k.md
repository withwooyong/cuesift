...
- [ ] **단계 1: 지금 없는 회귀 테스트를 먼저 쓴다 (변경 전에)**
...
- [ ] **단계 3: `_resolve_exclusive`를 N자로 고친다**
...
- [ ] **단계 6: 게이트를 실패시켜 본다 — 그물이 실제로 잡는지 확인한다**
