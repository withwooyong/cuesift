...
> 30회 호출·10320자 vs 묶었다면 3회·1599자 — 호출 10배, 프롬프트
> 6.5배. §4.1의 결정을 유지하고 이 절만 사실에 맞춰 정정한다.
...
| 이 설계 §6.3 | "배치·컨텍스트 윈도우를 재사용한다"가 §4.1의 세그먼트 단위 프로토콜과 모순 — 재사용되는 것은 재시도·실패 분류뿐임을 실측(30회/10320자 vs 3회/1599자)과 함께 정정 (Task 5 리뷰, Ruling P9 후속) |
