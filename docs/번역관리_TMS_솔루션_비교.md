...
> **작성 기준일**: 2026-07-08
>
> **목적**: 티빙(TVING) 규모의 **글로벌 K콘텐츠 OTT**에 도입할 다국어 번역관리(TMS)·현지화 솔루션을 전수 비교하고, **티빙 스택(Spring/Node·AWS)·규모에 맞는 추천안**을 근거·출처와 함께 도출한다. [글로벌_OTT_플랫폼.md](글로벌_OTT_플랫폼.md)의 "국제화(i18n/l10n)" 축 심화이며, 입사 후 글로벌 전략 자료(다음 단계)의 **③ 솔루션 선정** 근거가 된다.
>
