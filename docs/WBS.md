...
| 축 | 대상 | 완료 |
| --- | --- | --- |
| 상태 열 **있는** FR | 요구사항정의서 §5.4·§5.6·§5.7·**§5.8**의 **18개** | **17** - FR-4.1·4.3·6.1·6.2·**6.3**·6.4·6.5·7.1·7.2·7.3·7.4·7.5·8.1·8.2·8.3·8.4·8.5 (남은 하나는 FR-4.2 ⬜) |
...
| 1 | v0.1 잔여 - **FR-4.2 역번역**(⬜) | 42개 중 41개가 닫혀 **남은 것은 하나뿐이다.** **§12 Q4가 닫혔으므로(2026-09-04 spike, 임베딩이 8칸 전부에서 우위) 착수 근거가 생겼다** - 유사도 수단은 **임베딩 코사인**이고, 역번역 모델은 로컬로 충분하다. 착수할 때 `bench/inject.py`의 negation 주입 결함(이월 17번)을 **함께** 닫아야 한다 - 그 라벨이 이 신호의 정답지가 되는 순간이기 때문이다 |
