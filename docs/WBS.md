...
| 1 | WP6 나머지 (**FR-8.5**) | 진행 표시·CI(비대화형) 감지. **선행이 전부 풀린 유일한 항목이다** — FR-8.3(`transcribe` 배선)은 STT 어댑터(WP9)가 없으면 붙일 대상이 없다. FR-8.1은 WP7b가, **FR-8.4는 2026-08-28에** 닫았다 |
