...
| 2 | xCOMET 없이 **경량 신호만으로** 트리아지가 성립하는가? | ✅ **닫힘(2026-07-29)** | **예.** TED2020 ko-en·ko-ja 각 5,000건에 합성 오류를 주입해 실측 — 실제 검수 비율 10%에서 무작위 대비 **en-ko 6.96x · ja-ko 7.06x**. 근거: [`bench/results/en-ko-2026-07-29.md`](../bench/results/en-ko-2026-07-29.md) · [`bench/results/ja-ko-2026-07-29.md`](../bench/results/ja-ko-2026-07-29.md). **정정**: 이전에 "미결정 Q4와 같은 실험에서 답이 나온다"고 적었으나 틀렸다 — Q4(자가일관성 유사도)는 LLM 재번역이 필요한 **Tier 1** 질문이고 이 벤치는 그 계층을 측정하지 않는다. #2는 Tier 0만으로 닫혔고, Q4는 요구사항정의서 §12에 별도로 열려 있다 |
